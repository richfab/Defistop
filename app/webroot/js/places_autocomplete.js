...
function initialize() {
  ...
  var input = /** @type {HTMLInputElement} */(document.getElementById('PositionLieu'));
  var posLat = /** @type {HTMLInputElement} */(document.getElementById('PositionLat'));
  var posLon = /** @type {HTMLInputElement} */(document.getElementById('PositionLon'));
  var dist = /** @type {HTMLInputElement} */(document.getElementById('PositionDistance'));
  ...
  google.maps.event.addListener(autocomplete, 'place_changed', function() {
    ...
    if (place.geometry) {
      posLat.value = place.geometry.location.lat();
      posLon.value = place.geometry.location.lng();
